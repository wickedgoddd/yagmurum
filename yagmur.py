...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀        
    ...
    if menu == 1:
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Numarayı Gir Keke (+90) Sonra Enterla Beni Gardaş: "+ Fore.LIGHTGREEN_EX, end="")
            tel_no = input()
            ...
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Yarram Düzgün Numara Girsene?") 
            sleep(3)
            continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Bildiğin Mail Var Mı Keke Yoksa Bas Enter Geeeç "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
            if ("@" not in mail or ".com" not in mail) and mail != "":
                raise
        except:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Aptal Lan Bu Daha Mail Girmeyi Bilmiyor") 
            sleep(3)
            continue
        system("cls||clear")
        try:
            print(Fore.LIGHTGREEN_EX+"[+] "+Fore.CYAN+"Birden çok numara varsa her bir numara için.")
            print(Fore.LIGHTYELLOW_EX + "Kaç Tane Olsun Yavrum? (Abime 1.5 Gıymalıı)"+ Fore.LIGHTGREEN_EX, end="")  
            kere = input()
            if kere:
                kere = int(kere)
            else:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Kaç Saniyede Bir Gitsin Güzelimmm "+ Fore.LIGHTGREEN_EX, end="")
            aralik = int(input())
        except ValueError:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Hatalı giriş yaptınız. Tekrar deneyiniz.") 
                      ...
                      for attribute in dir(SendSms):
                          ...
                          if callable(attribute_value):
                              if attribute.startswith('__') == False:
                                  ...
                                  exec("sms."+attribute+"()")
                                  sleep(aralik)
                  print(Fore.LIGHTRED_EX + "\Sarıyorum Yine Baştan (Menüye Dönmek İçin Enter Basınız.)..")
                  input()
        elif kere is None: 
                  while True:
                      for attribute in dir(SendSms):
